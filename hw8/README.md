...
作業八說明 by [另一班助教](https://github.com/janice-cat)，供大家自由練習或單純看老師提了哪些概念。
* 原始出處: https://github.com/janice-cat/GenPhys2018FALL/tree/master/hw8

## 影片以及作業說明  

+ [影片](https://goo.gl/2jEFkT)  
+ [作業說明pdf](VP8.pdf)  
...
class CO_molecule:
    def __init__(self, pos, axis):
        ...
        self.bond = cylinder(pos = pos, axis = axis, radius = size/2.0, color = color.white) self.O.m = m_o
        self.C.m = m_c
